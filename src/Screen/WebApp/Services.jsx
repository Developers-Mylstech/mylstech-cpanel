                        ...
                        {data.map((item, idx) => (
                            <tr key={idx} className="border-b hover:bg-gray-50">
                                ...
                                <td className="py-3 px-4 font-semibold md:text-sm text-xs text-gray-800">
                                    {item.title}
                                    <p className="text-gray-400 font-normal text-xs mt-2"> {item.description}</p>
                                </td>
                                ...
                                <td className="py-3 px-4 flex items-center ">
                                    <span onClick={() => handleDailogBox(item)} className='border flex w-full rounded-lg overflow-hidden'>
        ...
        <section className="w-full mx-auto ">
            <div className="flex justify-end">
                <button
                    ...
                    className="bg-blue-900 uppercase px-10 py-1 mb-3 text-white text-sm font-semibold rounded-lg"
                >
                    Add New
                </button>
            </div>
