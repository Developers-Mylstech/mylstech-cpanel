...
const featuredServices = [
  {
    ...
    description:
      "We provide robust and high-performance hardware solutions to meet industry needs, ensuring efficiency and reliability.",
    image: [
      "https://img.freepik.com/free-photo/network-mainboard-service-toy-broadcasting_1286-290.jpg",
  ...
  },
  {
    title: "SEO Solutions",
    description:
      "Optimize your website for search engines to enhance visibility, drive organic traffic, and improve online presence.",
    image: [
      "https://img.freepik.com/free-vector/online-marketing-landing-page-illustrated_79603-1008.jpg",
    ],
  },
  {
    title: "Cloud Solutions",
    description:
      "Secure and scalable cloud solutions for data storage, application hosting, and business operations.",
    image: [
      "https://img.freepik.com/premium-vector/cloud-network-uploading-various-information-through-digital-systems_49459-616.jpg",
    ],
  },
];
...
const software = [
  {
    title: "Construction",
    description:
      "Advanced software solutions for the construction industry to streamline project management, budgeting, and workforce coordination.",
    para_1:
      "Our construction management software helps companies track projects, manage resources, and ensure compliance with safety regulations.",
    para_2:
      "We offer cloud-based solutions for real-time collaboration, cost estimation, and document management.",
    para_3:
      "With integrated analytics, businesses can monitor project progress, reduce delays, and improve overall efficiency.",
    image: [
      "https://cdn3d.iconscout.com/3d/premium/thumb/under-construction-3d-icon-download-in-png-blend-fbx-gltf-file-formats--worker-site-architecture-safety-helmet-tools-maintenance-and-pack-icons-6407256.png",
    ],
  ...
  },
  {
    title: "Automobile",
    description:
      "Automobile software solutions for vehicle management, maintenance tracking, and dealership automation.",
    para_1:
      "We provide software for automobile dealerships, fleet management, and automotive service centers.",
    para_2:
      "Our solutions include CRM tools, predictive maintenance, and real-time vehicle tracking systems.",
    para_3:
      "Enhanced automation ensures cost-effectiveness, operational efficiency, and improved customer experience.",
    image: [
      "https://www.freeiconspng.com/uploads/classic-car-series-texture-png-icon--icon-15.jpg",
    ],
    type: "Software Solutions",
  },
  {
    title: "Laundry",
    description:
      "Efficient laundry management software to automate order tracking, customer management, and billing.",
    para_1:
      "Our software helps laundromats and dry cleaners manage pickups, deliveries, and order processing.",
    para_2:
      "Automated invoicing, customer notifications, and seamless payment integration ensure smooth operations.",
    para_3:
      "Businesses can track inventory, monitor machine performance, and enhance customer satisfaction.",
    image: [
      "https://cdn3d.iconscout.com/3d/premium/thumb/washing-machine-3d-icon-download-in-png-blend-fbx-gltf-file-formats--laundry-household-home-living-pack-furniture-icons-4825944.png?f=webp",
    ],
    type: "Software Solutions",
  },
  {
    ...
    description:
      "Retail software solutions for inventory management, POS integration, and customer loyalty programs. sales tracking, and order fulfillment.",
    para_1:
      "Our grocery store software ensures efficient stock control, sales tracking, and order fulfillment.",
    para_2:
      "We offer AI-powered demand forecasting to optimize inventory and reduce wastage.",
    para_3:
      "With mobile ordering and self-checkout features, businesses can enhance customer convenience and sales.",
    image: [
      "https://cdn3d.iconscout.com/3d/premium/thumb/supermarket-3d-icon-download-in-png-blend-fbx-gltf-file-formats--grocery-shop-store-shopping-buying-and-groceries-pack-marketplace-icons-8817630.png",
    ],
    type: "Software Solutions",
  },
  {
    ...
    description:
      "Comprehensive restaurant and cafe management software to enhance ordering, kitchen workflows, order management, billing and customer experience.",
    para_1:
      "Our POS systems help restaurants streamline order management, billing, and kitchen coordination.",
    para_2:
      "Integrated online ordering, table reservations, and digital menus improve customer satisfaction.",
    para_3:
      "Advanced analytics provide insights into sales trends, inventory usage, and employee performance.",
    image: [
      "https://bvconuycpdvgzbvbkijl.supabase.co/storage/v1/object/public/sizes/845bf0-tea-cup/front/400/color.webp",
    ],
    type: "Software Solutions",
  },
  {
    title: "Hotels",
    description:
      "Hotel management solutions for reservations, billing, housekeeping, operations, bookings and guest services.",
    para_1:
      "Our software helps hotels automate front desk operations, bookings, and customer check-ins.",
    para_2:
      "Integrated CRM ensures personalized guest experiences and loyalty program management.",
    para_3:
      "Real-time reporting helps managers optimize room occupancy, pricing strategies, and operational efficiency.",
    image: [
      "https://cdn3d.iconscout.com/3d/premium/thumb/hotel-3d-illustration-download-in-png-blend-fbx-gltf-file-formats--room-restaurant-rest-house-accommodation-building-city-elements-pack-buildings-illustrations-4497530.png",
    ],
    type: "Software Solutions",
  },
  {
    ...
    description:
      "Facility management software for maintenance tracking, asset management, and space optimization.",
    para_1:
      "Our software streamlines facility maintenance by scheduling preventive and reactive repairs.",
    para_2:
      "Businesses can track asset lifecycles, monitor energy usage, and improve space utilization.",
    para_3:
      "Cloud-based dashboards provide real-time insights into operations and facility performance.",
    image: [
      "https://cdn3d.iconscout.com/3d/premium/thumb/property-management-3d-icon-download-in-png-blend-fbx-gltf-file-formats--building-apartment-house-real-estate-pack-buildings-icons-5727711.png",
    ],
    type: "Software Solutions",
  },
  {
    title: "Saloons",
    description:
      "Salon and spa software for appointment scheduling, customer management, and billing.",
    para_1:
      "Our software allows salons to manage bookings, track customer preferences, and automate reminders.",
    para_2:
      "Integrated POS solutions enable seamless billing, product sales, and financial reporting.",
    para_3:
      "With online booking and mobile apps, salons can enhance customer engagement and retention.",
    image: [
      "https://bvconuycpdvgzbvbkijl.supabase.co/storage/v1/object/public/sizes/e94351-scissor/front/400/color.webp",
    ],
    type: "Software Solutions",
  },
  {
    title: "Blog Material",
    description:
      "Content management solutions for bloggers, writers, monetization for bloggers and digital media companies.",
    para_1:
      "Our software simplifies content planning, publishing, and monetization for bloggers.",
    para_2:
      "SEO tools, analytics, and audience engagement features help optimize digital content.",
    para_3:
      "Integrated automation tools improve workflow, collaboration, and content distribution.",
    image: [
      "https://bvconuycpdvgzbvbkijl.supabase.co/storage/v1/object/public/sizes/5f20be-computer/front/400/color.webp",
    ],
    type: "Software Solutions",
  },
  {
    title: "Logistics",
    description:
      "Logistics management software for fleet tracking, warehouse automation, and supply chain optimization.",
    para_1:
      "Our software helps logistics businesses manage shipments, reduce delivery times, and optimize routes.",
    para_2:
      "Real-time tracking, AI-driven demand forecasting, and automated inventory control improve efficiency.",
    para_3:
      "Integrated dashboards provide insights into order status, fleet performance, and cost analysis.",
    image: [
      "https://cdn3d.iconscout.com/3d/premium/thumb/package-3d-icon-download-in-png-blend-fbx-gltf-file-formats--box-delivery-parcel-e-commerce-pack-shopping-icons-7849038.png?f=webp",
    ],
    type: "Software Solutions",
  },
  {
    ...
    description:
      "Business registration, compliance management, and corporate services for startups and enterprises.",
    para_1:
      "We provide end-to-end business setup services, including company registration, legal documentation, and licensing.",
    para_2:
      "Our compliance management tools ensure businesses meet regulatory requirements with ease.",
    para_3:
      "Advisory services help businesses optimize tax structures, HR policies, and operational strategies.",
    image: [
      "https://cdn3d.iconscout.com/3d/premium/thumb/service-3d-icon-download-in-png-blend-fbx-gltf-file-formats--support-cog-setting-business-and-finance-pack-icons-5752009.png?f=webp",
    ],
    type: "Software Solutions",
  },
];
...
export default function Services() {
  ...
  const renderSectionContent = (section) => {
        ...
        <table className="min-w-[800px] w-full bg-white rounded-t-lg shadow-md overflow-hidden">
          <thead className="bg-gray-100 text-gray-400 text-left uppercase text-xs">
            <tr>
              ...
              <th className="py-3 px-2 font-normal">On Hold</th>
              ...
              <tr key={idx} className="border-b hover:bg-gray-50">
                <td className="py-3 px-4 relative">
                  <img
                    ...
                    alt=""
                    className="h-16 w-24 object-cover rounded hover:cursor-pointer"
                    onClick={() => handleImageDialog(item.image)}
                  />
                  {Array.isArray(item.image) && item.image.length > 1 && (
                    <span className="absolute bottom-2 left-2 bg-black/60 text-white text-[10px] px-2 py-[2px] rounded">
                      +{item.image.length - 1}
                    </span>
                  )}
                </td>
                <td className="py-3 px-4 font-semibold md:text-sm text-xs text-gray-800">
                  {item.title}
                </td>
                <td className="py-3 px-4 md:text-sm text-xs text-gray-600">
                  {item.description}
                </td>
                <td className="py-3 px-4 ">
                  {/* <button
                    onClick={() => toggleHold(item.title)}
                    className={`md:text-sm text-xs ${
                      holdStates[item.title] ? "bg-yellow-300" : "bg-purple-400"
                    } text-white p-2 rounded-lg`}
                  >
                    {holdStates[item.title] ? "Unhold" : "Hold"}
                  </button> */}

                  <InputSwitch
                    checked={holdStates[item.title] || false}
                    onChange={() => toggleHold(item.title)}
                  />
                </td>
                <td className="py-3 px-4 flex justify-center items-center gap-2 ">
                  <button
                    className="text-lg text-white bg-blue-900 py-2 px-4 rounded-lg mt-4"
                    onClick={() => handleDailogBox(item)}
                  >
                    <FiEdit2 />
                  </button>
                  <button className="text-lg text-white bg-blue-900 py-2 px-4 rounded-lg mt-4 ">
                    <IoIosTrash />
                  </button>
                </td>
              </tr>
    ...
    switch (section.key) {
      case "featured":
        return renderTable(featuredServices);
      case "software":
        return renderTable(software);
      case "other":
        return renderTable(otherService);
      default:
        return null;
    }
  };
    ...
    <section className="w-full mx-auto ">
      <div className="flex justify-end">
        <button
          ...
          className="bg-blue-900 uppercase px-10 py-1 my-3 text-white text-sm font-semibold rounded-lg"
        >
          Add New
        </button>
      </div>
      <Dialog
        ...
        className="lg:w-1/2  md:w-[80%] w-[90%] mx-2 h-fit"
        blockScroll
        draggable={false}
      ...
      <Dialog
        ...
        blockScroll
        draggable={false}
        onHide={() => setImageDialogOpen(false)}
      >
