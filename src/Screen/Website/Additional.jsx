    ...
    <div className="my-5 space-y-10">
      ...
      <section className="bg-white border p-6 rounded-lg">
        ...
        <div className='flex-col md:flex-row flex gap-4 justify-between my-5'>
            ...
            <button className="bg-pri w-full md:w-fit text-white px-4 py-2 h-fit flex items-center gap-3 rounded-md hover:bg-purple-700"> <RxUpdate /> Update Logos</button>
          </div>
